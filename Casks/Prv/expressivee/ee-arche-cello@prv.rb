cask "ee-arche-cello@prv" do
  ...
  name "ExpressiveE Arche Cello"
  desc "Phyiscal modelled cello, part of Arche Collection"
  homepage "https://www.expressivee.com/21-arche-collection"

  auto_updates false

  pkg "ArcheCello_#{version}_#{arch.upcase}.pkg"

  uninstall pkgutil: "com.expressivee.ArcheCello.*"
end
