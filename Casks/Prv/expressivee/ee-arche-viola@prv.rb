cask "ee-arche-viola@prv" do
  ...
  name "ExpressiveE Arche Viola"
  desc "Phyiscal modelled viola, part of Arche Collection"
  homepage "https://www.expressivee.com/21-arche-collection"

  auto_updates false

  pkg "ArcheViola_#{version}_#{arch.upcase}.pkg"

  uninstall pkgutil: "com.expressivee.ArcheViola.*"
end
