cask "soniccharge-microtonic@prv" do
  class << self
  ...
  name "Sonic Charge Microtonic"
  desc "Drum synth with pattern sequencer"
  homepage "https://soniccharge.com/microtonic"
  ...
  uninstall pkgutil: "com.soniccharge.microtonic"
end
