cask "soniccharge-echobode@prv" do
  module Utils
  ...
  name "Sonic Charge Echobode"
  desc "Delay with frequency shifter"
  homepage "https://soniccharge.com/echobode"
  ...
  uninstall pkgutil: "com.soniccharge.echobode"
end
