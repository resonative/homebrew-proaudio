cask "mh-transientcontrol" do
  ...
  name "Metric Halo MH TransientControl v4"
  desc "Transient processor"
  ...
  uninstall pkgutil: "com.mhlabs.MHProductionBundleInstaller_*.MHTransientControl_v4",
            delete:  [
              # pkgutil will delete aax
              "/Library/Audio/Plug-Ins/Components/MHTransientControl_v4.component/",
              "/Library/Audio/Plug-Ins/VST/MHTransientControl_v4.vst/",
              "/Library/Audio/Plug-Ins/VST3/MHTransientControl_v4.vst3/",
              "/tmp/com.mhlabs.installer.plugintypes",
              "/tmp/MHTransientControl_v4_install.log",
            ]
end
