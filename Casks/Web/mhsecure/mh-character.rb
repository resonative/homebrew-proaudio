cask "mh-character" do
  ...
  uninstall pkgutil: "com.mhlabs.MHProductionBundleInstaller_*.MHCharacter_v4",
            delete:  [
              # pkgutil will delete aax
              "/Library/Audio/Plug-Ins/Components/MHCharacter_v4.component/",
              "/Library/Audio/Plug-Ins/VST/MHCharacter_v4.vst/",
              "/Library/Audio/Plug-Ins/VST3/MHCharacter_v4.vst3/",
              "/tmp/com.mhlabs.installer.plugintypes",
              "/tmp/MHCharacter_v4_install.log",
            ]
end
