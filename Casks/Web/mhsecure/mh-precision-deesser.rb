cask "mh-precision-deesser" do
  ...
  name "Metric Halo MH Precision DeEsser v4"
  desc "De-esser"
  ...
  uninstall pkgutil: "com.mhlabs.MHProductionBundleInstaller_*.MHPrecisionDeesser_v4",
            delete:  [
              # pkgutil will delete aax
              "/Library/Audio/Plug-Ins/Components/MHPrecisionDeesser_v4.component/",
              "/Library/Audio/Plug-Ins/VST/MHPrecisionDeesser_v4.vst/",
              "/Library/Audio/Plug-Ins/VST3/MHPrecisionDeesser_v4.vst3/",
              "/tmp/com.mhlabs.installer.plugintypes",
              "/tmp/MHPrecisionDeesser_v4_install.log",
            ]
end
