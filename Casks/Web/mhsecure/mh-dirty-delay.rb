cask "mh-dirty-delay" do
  ...
  name "Metric Halo MH Dirty Delay v4"
  desc "Vintage echo and delay"
  ...
  uninstall pkgutil: "com.mhlabs.MHProductionBundleInstaller_*.MHDirtyDelay_v4",
            delete:  [
              # pkgutil will delete aax
              "/Library/Audio/Plug-Ins/Components/MHDirtyDelay_v4.component/",
              "/Library/Audio/Plug-Ins/VST/MHDirtyDelay_v4.vst/",
              "/Library/Audio/Plug-Ins/VST3/MHDirtyDelay_v4.vst3/",
              "/tmp/com.mhlabs.installer.plugintypes",
              "/tmp/MHDirtyDelay_v4_install.log",
            ]
end
