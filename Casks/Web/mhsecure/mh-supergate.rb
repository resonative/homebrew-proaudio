cask "mh-supergate" do
  ...
  name "Metric Halo MH SuperGate v4"
  desc "Audio gate dynmaic processor"
  ...
  uninstall pkgutil: "com.mhlabs.MHProductionBundleInstaller_*.MHSuperGate_v4",
            delete:  [
              # pkgutil will delete aax
              "/Library/Audio/Plug-Ins/Components/MHSuperGate_v4.component/",
              "/Library/Audio/Plug-Ins/VST/MHSuperGate_v4.vst/",
              "/Library/Audio/Plug-Ins/VST3/MHSuperGate_v4.vst3/",
              "/tmp/com.mhlabs.installer.plugintypes",
              "/tmp/MHSuperGate_v4_install.log",
            ]
end
